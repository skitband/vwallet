...
Vue.component('edit-wallet-component', require('./components/EditWalletComponent.vue').default);
...
Vue.component('create-transaction-component', require('./components/CreateTransactionComponent.vue').default);
